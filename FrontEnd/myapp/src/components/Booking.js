...
handleTimeChange = (time) => {
  ...
  onSubmit = (event) =>{
    event.preventDefault()
      axios.get(`http://ec2-54-208-156-197.compute-1.amazonaws.com:8080/api/services/findEmployees/${this.state.selectedService}`)
      .then(response => {
      ...
      axios.get(`http://ec2-54-208-156-197.compute-1.amazonaws.com:8080/api/services/findService/${this.state.workerUsername}`)
      .then(response => {
